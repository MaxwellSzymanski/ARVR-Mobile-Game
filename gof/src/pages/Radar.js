...
class Radar extends React.Component {
    ...
    ComponentDidMount() {
      var urlD = 'http://localhost:8080'; // adres server


      var dataCookie = {};

      dataCookie.idPlayer="1";
