         ...
         <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
          ...
          <tr>
           <td align="center" bgcolor="white"><font color="black" style="font-family:times new roman;">
             ...
             <h4>We are happy to welcome you to the world of <font color="#910f0f">Game of Wolves</font>!</br>To start your adventure, you first have to verify this e-mail account.</h4>
             <h4>This is your verification code: </h4>
             <div style="display:inline-block">  <h1 style="border:3px; border-style:solid; border-color:#910f0f; letter-spacing: 0.1em;">  ${this.verifCode.toString()}  </h1>  </div>
