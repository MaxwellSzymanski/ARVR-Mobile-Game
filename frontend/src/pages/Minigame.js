...
class Minigame extends React.Component {
    ...
    render() {
        ...
        return(
            <Map ref={(ref) => { this.map = ref; }} scrollWheelZoom="center" dragging={false} onViewportChange={()=> this.setZoom()} onClick={()=> this.mapChanged()} className="mapss" center={this.state.centerMap} zoom={this.state.zoom}>
                <TileLayer
